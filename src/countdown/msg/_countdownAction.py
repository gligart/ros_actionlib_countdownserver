"""autogenerated by genpy from countdown/countdownAction.msg. Do not edit."""
import sys
...
import countdown.msg

class countdownAction(genpy.Message):
  _md5sum = "bb043bcf65d97c5c6a06c2ba6346c3f8"
  _type = "countdown/countdownAction"
...
"""
  ...
  _slot_types = ['countdown/countdownActionGoal','countdown/countdownActionResult','countdown/countdownActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(countdownAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = countdown.msg.countdownActionGoal()
      if self.action_result is None:
        self.action_result = countdown.msg.countdownActionResult()
      if self.action_feedback is None:
        self.action_feedback = countdown.msg.countdownActionFeedback()
    else:
      self.action_goal = countdown.msg.countdownActionGoal()
      self.action_result = countdown.msg.countdownActionResult()
      self.action_feedback = countdown.msg.countdownActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.number, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.executed, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.elapsed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.number, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.executed, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_result.result.executed = bool(self.action_result.result.executed)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.elapsed,) = _struct_i.unpack(str[start:end])
      return self
