"""autogenerated by genpy from countdown/countdownActionFeedback.msg. Do not edit."""
import sys
...
class countdownActionFeedback(genpy.Message):
  _md5sum = "4dbec60d2b61f8a841d5750e07cd2896"
  _type = "countdown/countdownActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','countdown/countdownFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(countdownActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = countdown.msg.countdownFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = countdown.msg.countdownFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.feedback.elapsed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.elapsed,) = _struct_i.unpack(str[start:end])
      return self
